...
object FeatureFlags {
     ...
     * */
    val customExtensionCollectionFeature = org.halalz.fenix.Config.channel.isNightlyOrDebug || org.halalz.fenix.Config.channel.isBeta
    ...
    fun isPocketSponsoredStoriesFeatureEnabled(context: Context): Boolean {
        return org.halalz.fenix.FeatureFlags.isPocketRecommendationsFeatureEnabled(context)
    }

    /**
     * Enables compose on the tabs tray items.
     */
    val composeTabsTray = org.halalz.fenix.Config.channel.isNightlyOrDebug || org.halalz.fenix.Config.channel.isBeta
     ...
     */
    val translations = org.halalz.fenix.Config.channel.isDebug
     ...
     */
    val metaAttributionEnabled = org.halalz.fenix.Config.channel.isNightlyOrDebug

    /**
     * Enable Toolbar Redesign components and behaviors ready for Nightly.
     */
    val completeToolbarRedesignEnabled = org.halalz.fenix.Config.channel.isNightlyOrDebug

    /**
     * Enable Toolbar Redesign partial components and behaviors.
     */
    val incompleteToolbarRedesignEnabled = org.halalz.fenix.Config.channel.isDebug
}
