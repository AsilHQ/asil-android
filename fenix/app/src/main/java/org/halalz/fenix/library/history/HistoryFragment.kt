...
package org.halalz.fenix.library.history
...
import org.halalz.fenix.NavHostActivity
import org.halalz.fenix.R
import org.halalz.fenix.addons.showSnackBar
import org.halalz.fenix.browser.browsingmode.BrowsingMode
import org.halalz.fenix.components.StoreProvider
import org.halalz.fenix.components.history.DefaultPagedHistoryProvider
...
import org.halalz.fenix.ext.setTextColor
import org.halalz.fenix.library.LibraryPageFragment
import org.halalz.fenix.library.history.state.HistoryNavigationMiddleware
import org.halalz.fenix.library.history.state.HistoryStorageMiddleware
import org.halalz.fenix.library.history.state.HistorySyncMiddleware
import org.halalz.fenix.library.history.state.HistoryTelemetryMiddleware
import org.halalz.fenix.library.history.state.bindings.MenuBinding
import org.halalz.fenix.library.history.state.bindings.PendingDeletionBinding
import org.halalz.fenix.tabstray.Page
import org.halalz.fenix.utils.allowUndo
import org.halalz.fenix.databinding.FragmentHistoryBinding
import org.halalz.fenix.GleanMetrics.History as GleanHistory
...
class HistoryFragment : LibraryPageFragment<History>(), UserInteractionHandler, MenuProvider {
    ...
    private fun openItem(item: History.Regular) = runIfFragmentIsAttached {
        ...
        (activity as HomeActivity).openToBrowserAndLoad(
            ...
            newTab = true,
            from = org.halalz.fenix.BrowserDirection.FromHistory,
        )
    }
