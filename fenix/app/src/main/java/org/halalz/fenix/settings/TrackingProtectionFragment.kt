...
import org.halalz.fenix.trackingprotection.TrackingProtectionMode
 ...
 * to open info about the tracking protection [org.halalz.fenix.settings.TrackingProtectionFragment].
 */
    ...
    override fun onResume() {
        ...
        learnMorePreference.setOnPreferenceClickListener {
            (activity as HomeActivity).openToBrowserAndLoad(
                ...
                newTab = true,
                from = org.halalz.fenix.BrowserDirection.FromTrackingProtection,
            )
            true
        }
