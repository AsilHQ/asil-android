...
import org.halalz.fenix.components.search.SearchMigration
...
import org.halalz.fenix.gecko.GeckoProvider
import org.halalz.fenix.historymetadata.DefaultHistoryMetadataService
import org.halalz.fenix.historymetadata.HistoryMetadataMiddleware
import org.halalz.fenix.historymetadata.HistoryMetadataService
import org.halalz.fenix.media.MediaSessionService
...
import org.halalz.fenix.settings.advanced.getSelectedLocale
import org.halalz.fenix.share.SaveToPDFMiddleware
import org.halalz.fenix.telemetry.TelemetryMiddleware
import org.halalz.fenix.utils.getUndoDelay
...
class Core(
    ...
    val engine: Engine by lazyMonitored {
        ...
        GeckoEngine(
             ...
             */
            if (org.halalz.fenix.Config.channel.isNightlyOrDebug || org.halalz.fenix.Config.channel.isBeta) {
     ...
     */
    val requestInterceptor = org.halalz.fenix.AppRequestInterceptor(context)
    ...
    private val locationService: LocationService by lazyMonitored {
        if (org.halalz.fenix.Config.channel.isDebug || BuildConfig.MLS_TOKEN.isEmpty()) {
    ...
    val topSitesStorage by lazyMonitored {
        ...
        strictMode.resetAfter(StrictMode.allowThreadDiskReads()) {
            if (!context.settings().defaultTopSitesAdded) {
                if (org.halalz.fenix.Config.channel.isMozillaOnline) {
                    defaultTopSites.add(
                        Pair(
    ...
    private fun getSecureAbove22Preferences() =
        SecureAbove22Preferences(
            ...
            forceInsecure = !org.halalz.fenix.Config.channel.isNightlyOrDebug,
        )
