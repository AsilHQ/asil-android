...
import org.halalz.fenix.GleanMetrics.Addons
import org.halalz.fenix.GleanMetrics.Addresses
import org.halalz.fenix.GleanMetrics.AndroidAutofill
import org.halalz.fenix.GleanMetrics.CreditCards
import org.halalz.fenix.GleanMetrics.CustomizeHome
import org.halalz.fenix.GleanMetrics.Events.marketingNotificationAllowed
import org.halalz.fenix.GleanMetrics.GleanBuildInfo
import org.halalz.fenix.GleanMetrics.Logins
import org.halalz.fenix.GleanMetrics.Metrics
import org.halalz.fenix.GleanMetrics.PerfStartup
import org.halalz.fenix.GleanMetrics.Preferences
import org.halalz.fenix.GleanMetrics.SearchDefaultEngine
import org.halalz.fenix.GleanMetrics.ShoppingSettings
import org.halalz.fenix.GleanMetrics.TopSites
...
import org.halalz.fenix.components.metrics.MetricServiceType
import org.halalz.fenix.components.metrics.MozillaProductDetector
import org.halalz.fenix.experiments.maybeFetchExperiments
import org.halalz.fenix.ext.components
import org.halalz.fenix.ext.containsQueryParameters
import org.halalz.fenix.ext.getCustomGleanServerUrlIfAvailable
import org.halalz.fenix.ext.isCustomEngine
import org.halalz.fenix.ext.isKnownSearchDomain
import org.halalz.fenix.ext.setCustomEndpointIfAvailable
import org.halalz.fenix.ext.settings
import org.halalz.fenix.host_blocker.HostBlockerWorker
import org.halalz.fenix.lifecycle.StoreLifecycleObserver
import org.halalz.fenix.onboarding.MARKETING_CHANNEL_ID
import org.halalz.fenix.perf.MarkersActivityLifecycleCallbacks
import org.halalz.fenix.perf.ProfilerMarkerFactProcessor
import org.halalz.fenix.perf.StartupTimeline
import org.halalz.fenix.perf.StorageStatsMetrics
import org.halalz.fenix.perf.runBlockingIncrement
import org.halalz.fenix.push.PushFxaIntegration
import org.halalz.fenix.push.WebPushEngineIntegration
import org.halalz.fenix.session.PerformanceActivityLifecycleCallbacks
import org.halalz.fenix.session.VisibilityLifecycleCallback
import org.halalz.fenix.utils.Settings
import org.halalz.fenix.utils.Settings.Companion.TOP_SITES_PROVIDER_MAX_THRESHOLD
...
open class FenixApplication : LocaleAwareApplication(), Provider {
    ...
    protected open fun initializeGlean() {
        ...
        val customEndpoint = if (org.halalz.fenix.Config.channel.isNightlyOrDebug) {
    ...
    protected open fun setupInAllProcesses() {
        ...
        Log.addSink(
            org.halalz.fenix.FenixLogSink(
                logsDebug = org.halalz.fenix.Config.channel.isDebug,
                AndroidLogSink()
            )
        )
    }
    ...
    private fun finishSetupMegazord(): Deferred<Unit> {
        return GlobalScope.async(IO) {
            if (org.halalz.fenix.Config.channel.isDebug) {
    ...
    internal fun setStartupMetrics(
        ...
        with(Metrics) {
            ...
            distributionId.set(
                when (org.halalz.fenix.Config.channel.isMozillaOnline) {
                    true -> "MozillaOnline"
                    false -> "Mozilla"
                },
            )
    ...
    private fun Long.toRoundedMegabytes(): Long = (this / org.halalz.fenix.BYTES_TO_MEGABYTES_CONVERSION).roundToLong()

    private fun isDeviceRamAboveThreshold() = deviceRamApproxMegabytes() > org.halalz.fenix.RAM_THRESHOLD_MEGABYTES
    ...
    internal fun shouldShowPrivacyNotice(): Boolean {
        return org.halalz.fenix.Config.channel.isMozillaOnline &&
