...
package org.halalz.fenix.settings.account
...
import org.halalz.fenix.databinding.FragmentTurnOnSyncBinding
...
class TurnOnSyncFragment : Fragment(), AccountObserver {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.signInInstructions.text = HtmlCompat.fromHtml(
            if (requireContext().settings().allowDomesticChinaFxaServer && org.halalz.fenix.Config.channel.isMozillaOnline) {
