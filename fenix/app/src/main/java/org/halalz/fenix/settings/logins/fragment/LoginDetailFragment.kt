...
package org.halalz.fenix.settings.logins.fragment
...
import org.halalz.fenix.databinding.FragmentLoginDetailBinding
...
import org.halalz.fenix.ext.simplifiedUrl
import org.halalz.fenix.settings.logins.LoginsFragmentStore
import org.halalz.fenix.settings.logins.SavedLogin
import org.halalz.fenix.settings.logins.controller.SavedLoginsStorageController
import org.halalz.fenix.settings.logins.createInitialLoginsListState
import org.halalz.fenix.settings.logins.interactor.LoginDetailInteractor
import org.halalz.fenix.settings.logins.togglePasswordReveal
import org.halalz.fenix.settings.logins.view.LoginDetailsBindingDelegate
...
class LoginDetailFragment : SecureFragment(R.layout.fragment_login_detail), MenuProvider {
    ...
    private fun navigateToBrowser(address: String) {
        (activity as HomeActivity).openToBrowserAndLoad(
            address,
            newTab = true,
            from = org.halalz.fenix.BrowserDirection.FromLoginDetailFragment,
        )
    }
