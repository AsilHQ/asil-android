...
package org.halalz.fenix.library.recentlyclosed
...
import org.halalz.fenix.GleanMetrics.RecentlyClosedTabs
...
import org.halalz.fenix.databinding.FragmentRecentlyClosedTabsBinding
...
class RecentlyClosedFragment :
    ...
    private fun openItem(url: String, mode: BrowsingMode? = null) {
        ...
        (activity as HomeActivity).openToBrowserAndLoad(
            searchTermOrURL = url,
            newTab = true,
            from = org.halalz.fenix.BrowserDirection.FromRecentlyClosed,
        )
    }
