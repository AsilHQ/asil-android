...
import org.halalz.fenix.databinding.FragmentAddOnsManagementBinding
...
class AddonsManagementFragment : Fragment(R.layout.fragment_add_ons_management) {
    ...
    private fun bindRecyclerView() {
        ...
        lifecycleScope.launch(IO) {
            try {
                ...
                val excludedAddonIDs = if (org.halalz.fenix.Config.channel.isMozillaOnline &&
    ...
    private fun openLinkInNewTab(url: String) {
        (activity as HomeActivity).openToBrowserAndLoad(
            searchTermOrURL = url,
            newTab = true,
            from = org.halalz.fenix.BrowserDirection.FromAddonsManagementFragment,
        )
    }
