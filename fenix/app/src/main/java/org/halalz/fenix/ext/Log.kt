...
inline fun logDebug(tag: String, message: String) {
    if (org.halalz.fenix.Config.channel.isDebug) Log.d(tag, message)
}
...
inline fun logWarn(tag: String, message: String) {
    if (org.halalz.fenix.Config.channel.isDebug) Log.w(tag, message)
}
...
inline fun logWarn(tag: String, message: String, err: Throwable) {
    if (org.halalz.fenix.Config.channel.isDebug) Log.w(tag, message, err)
}
...
inline fun logErr(tag: String, message: String, err: Throwable) {
    if (org.halalz.fenix.Config.channel.isDebug) Log.e(tag, message, err)
}
