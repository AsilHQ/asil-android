...
package org.halalz.fenix.utils
...
import org.halalz.fenix.components.settings.counterPreference
import org.halalz.fenix.components.settings.featureFlagPreference
import org.halalz.fenix.components.settings.lazyFeatureFlagPreference
import org.halalz.fenix.components.toolbar.ToolbarPosition
import org.halalz.fenix.ext.components
import org.halalz.fenix.ext.getPreferenceKey
import org.halalz.fenix.nimbus.CookieBannersSection
import org.halalz.fenix.nimbus.FxNimbus
import org.halalz.fenix.nimbus.HomeScreenSection
import org.halalz.fenix.nimbus.Mr2022Section
import org.halalz.fenix.nimbus.QueryParameterStrippingSection
import org.halalz.fenix.nimbus.QueryParameterStrippingSection.QUERY_PARAMETER_STRIPPING
import org.halalz.fenix.nimbus.QueryParameterStrippingSection.QUERY_PARAMETER_STRIPPING_ALLOW_LIST
import org.halalz.fenix.nimbus.QueryParameterStrippingSection.QUERY_PARAMETER_STRIPPING_PMB
import org.halalz.fenix.nimbus.QueryParameterStrippingSection.QUERY_PARAMETER_STRIPPING_STRIP_LIST
import org.halalz.fenix.settings.PhoneFeature
import org.halalz.fenix.settings.deletebrowsingdata.DeleteBrowsingDataOnQuitType
import org.halalz.fenix.settings.logins.SavedLoginsSortingStrategyMenu
import org.halalz.fenix.settings.logins.SortingStrategy
import org.halalz.fenix.settings.registerOnSharedPreferenceChangeListener
import org.halalz.fenix.settings.sitepermissions.AUTOPLAY_BLOCK_ALL
import org.halalz.fenix.settings.sitepermissions.AUTOPLAY_BLOCK_AUDIBLE
...
class Settings(private val appContext: Context) : PreferencesHolder {
    ...
    internal val isCrashReportEnabledInBuild: Boolean =
        BuildConfig.CRASH_REPORTING && org.halalz.fenix.Config.channel.isReleased
    ...
    var isMarketingTelemetryEnabled by booleanPreference(
        ...
        default = !org.halalz.fenix.Config.channel.isMozillaOnline,
    )
    ...
    val toolbarPosition: ToolbarPosition
        get() = if (shouldUseBottomToolbar) ToolbarPosition.TOP else ToolbarPosition.TOP
    ...
    var enableGeckoLogs by booleanPreference(
        ...
        default = org.halalz.fenix.Config.channel.isDebug,
    )
    ...
    var isPullToRefreshEnabledInBrowser by booleanPreference(
        ...
        default = org.halalz.fenix.Config.channel.isNightlyOrDebug,
    )
    ...
    var showPocketRecommendationsFeature by lazyFeatureFlagPreference(
        ...
        featureFlag = org.halalz.fenix.FeatureFlags.isPocketRecommendationsFeatureEnabled(appContext),
    ...
    val showPocketSponsoredStories by lazyFeatureFlagPreference(
        ...
        featureFlag = org.halalz.fenix.FeatureFlags.isPocketSponsoredStoriesFeatureEnabled(appContext),
    )
    ...
    var enableTabsTrayToCompose by booleanPreference(
        ...
        default = org.halalz.fenix.FeatureFlags.composeTabsTray,
    )
    ...
    var enableComposeTopSites by booleanPreference(
        ...
        default = org.halalz.fenix.FeatureFlags.composeTopSites,
    )
     ...
     */
    var enableUnifiedSearchSettingsUI: Boolean = showUnifiedSearchFeature && org.halalz.fenix.FeatureFlags.unifiedSearchSettings
    ...
    var enableFxSuggest by lazyFeatureFlagPreference(
        ...
        featureFlag = org.halalz.fenix.FeatureFlags.fxSuggest,
    )
    ...
    var enableRedesignToolbar by lazyFeatureFlagPreference(
        ...
        default = { false },
        featureFlag = org.halalz.fenix.FeatureFlags.completeToolbarRedesignEnabled,
    )
    ...
    var enableIncompleteToolbarRedesign by lazyFeatureFlagPreference(
        ...
        default = { false },
        featureFlag = org.halalz.fenix.FeatureFlags.incompleteToolbarRedesignEnabled,
    )
}
