...
import org.halalz.fenix.GleanMetrics.AppTheme
import org.halalz.fenix.GleanMetrics.PullToRefreshInBrowser
import org.halalz.fenix.GleanMetrics.ToolbarSettings
...
class CustomizationFragment : PreferenceFragmentCompat() {
    ...
    private fun setupGesturesCategory() {
        requirePreference<SwitchPreference>(R.string.pref_key_website_pull_to_refresh).apply {
            isVisible = org.halalz.fenix.FeatureFlags.pullToRefreshEnabled
