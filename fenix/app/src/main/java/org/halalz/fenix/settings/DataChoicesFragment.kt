...
class DataChoicesFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        requirePreference<SwitchPreference>(R.string.pref_key_marketing_telemetry).apply {
            isChecked = (context.settings().isMarketingTelemetryEnabled) && (!org.halalz.fenix.Config.channel.isMozillaOnline)
            onPreferenceChangeListener = SharedPreferenceUpdater()
            isVisible = !org.halalz.fenix.Config.channel.isMozillaOnline
        }
    }
