...
import org.halalz.fenix.GleanMetrics.SyncAuth
...
import org.halalz.fenix.sync.SyncedTabsIntegration
...
class BackgroundServices(
    ...
    private val deviceConfig = DeviceConfig(
        ...
        secureStateAtRest = org.halalz.fenix.Config.channel.isNightlyOrDebug,
    )
    ...
    val supportedEngines =
        setOfNotNull(
            ...
            if (org.halalz.fenix.FeatureFlags.syncAddressesFeature) SyncEngine.Addresses else null,
        )
    ...
    init {
        ...
        if (org.halalz.fenix.FeatureFlags.syncAddressesFeature) {
