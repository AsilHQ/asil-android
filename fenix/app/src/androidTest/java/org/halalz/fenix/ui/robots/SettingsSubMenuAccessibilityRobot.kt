...
import org.halalz.fenix.helpers.assertIsEnabled
import org.halalz.fenix.helpers.isEnabled
import org.halalz.fenix.ui.robots.SettingsSubMenuAccessibilityRobot.Companion.DECIMAL_CONVERSION
import org.halalz.fenix.ui.robots.SettingsSubMenuAccessibilityRobot.Companion.MIN_VALUE
import org.halalz.fenix.ui.robots.SettingsSubMenuAccessibilityRobot.Companion.STEP_SIZE
import org.halalz.fenix.ui.robots.SettingsSubMenuAccessibilityRobot.Companion.TEXT_SIZE
...
private fun assertSliderBar() {
    onView(withId(org.halalz.fenix.R.id.sampleText))
    ...
    onView(withId(org.halalz.fenix.R.id.seekbar_value))
        .check(matches(withText("100%")))

    onView(withId(org.halalz.fenix.R.id.seekbar))
        .check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
}
...
private fun assertMenuItemsAreDisabled() {
    ...
    onView(withId(org.halalz.fenix.R.id.sampleText)).assertIsEnabled(false)

    onView(withId(org.halalz.fenix.R.id.seekbar_value)).assertIsEnabled(false)

    onView(withId(org.halalz.fenix.R.id.seekbar)).assertIsEnabled(false)
}
