...
import org.halalz.fenix.GleanMetrics.ErrorPage
import org.halalz.fenix.ext.components
import org.halalz.fenix.ext.isOnline
...
class AppRequestInterceptor(
    ...
    private fun getRiskLevel(errorType: ErrorType): org.halalz.fenix.AppRequestInterceptor.RiskLevel = when (errorType) {
        ErrorType.UNKNOWN,
        ...
        -> org.halalz.fenix.AppRequestInterceptor.RiskLevel.Low

        ErrorType.ERROR_SECURITY_BAD_CERT,
        ErrorType.ERROR_SECURITY_SSL,
        ErrorType.ERROR_PORT_BLOCKED,
        -> org.halalz.fenix.AppRequestInterceptor.RiskLevel.Medium

        ErrorType.ERROR_SAFEBROWSING_HARMFUL_URI,
        ErrorType.ERROR_SAFEBROWSING_MALWARE_URI,
        ErrorType.ERROR_SAFEBROWSING_PHISHING_URI,
        ErrorType.ERROR_SAFEBROWSING_UNWANTED_URI,
        -> org.halalz.fenix.AppRequestInterceptor.RiskLevel.High
    }

    private fun getErrorPageTitle(context: Context, type: ErrorType): String? {
        return when (type) {
            ErrorType.ERROR_HTTPS_ONLY -> context.getString(org.halalz.fenix.R.string.errorpage_httpsonly_title)
    ...
    private fun getErrorPageDescription(context: Context, type: ErrorType): String? {
        return when (type) {
            ErrorType.ERROR_HTTPS_ONLY ->
                context.getString(org.halalz.fenix.R.string.errorpage_httpsonly_message_title) +
                    "<br><br>" +
                    context.getString(org.halalz.fenix.R.string.errorpage_httpsonly_message_summary)
    ...
    internal enum class RiskLevel(val htmlRes: String) {
        Low(org.halalz.fenix.AppRequestInterceptor.Companion.LOW_AND_MEDIUM_RISK_ERROR_PAGES),
        Medium(org.halalz.fenix.AppRequestInterceptor.Companion.LOW_AND_MEDIUM_RISK_ERROR_PAGES),
        High(org.halalz.fenix.AppRequestInterceptor.Companion.HIGH_RISK_ERROR_PAGES),
    }
