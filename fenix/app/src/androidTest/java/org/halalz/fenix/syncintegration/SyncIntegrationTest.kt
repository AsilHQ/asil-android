...
package org.halalz.fenix.syncintegration
...
import org.halalz.fenix.ui.robots.accountSettings
import org.halalz.fenix.ui.robots.homeScreen
import org.halalz.fenix.ui.robots.settingsSubMenuLoginsAndPassword
...
class SyncIntegrationTest {
    ...
    fun syncHistoryBetweenMobileAndDesktopTest() {
        ...
        mDevice.waitNotNull(Until.findObjects(By.res("org.halalz.fenix.debug:id/counter_root")))
        homeScreen {
        }.openThreeDotMenu {
        }.openHistory {
        }
    ...
    fun tapReturnToPreviousApp() {
        ...
        mDevice.waitNotNull(Until.findObjects(By.text("Account")), TestAssetHelper.waitingTime)
        mDevice.waitNotNull(Until.findObjects(By.res("org.halalz.fenix.debug:id/email")), TestAssetHelper.waitingTime)
        TestAssetHelper.waitingTime
        // Go to Homescreen
        mDevice.pressBack()
    }
