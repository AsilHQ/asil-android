...
import org.halalz.fenix.AppRequestInterceptor.Companion.HIGH_RISK_ERROR_PAGES
import org.halalz.fenix.AppRequestInterceptor.Companion.LOW_AND_MEDIUM_RISK_ERROR_PAGES
...
class AppRequestInterceptorTest {
    ...
    @Before
    fun setUp() {
        mockkStatic("org.halalz.fenix.ext.ConnectivityManagerKt")
        ...
        interceptor = org.halalz.fenix.AppRequestInterceptor(testContext).also {
