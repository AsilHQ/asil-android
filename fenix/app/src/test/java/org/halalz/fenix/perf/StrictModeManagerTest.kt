...
class StrictModeManagerTest {
    ...
    fun setup() {
        ...
        val debugConfig: org.halalz.fenix.Config = mockk { every { channel } returns org.halalz.fenix.ReleaseChannel.Debug }
        debugManager = StrictModeManager(debugConfig, components)

        val releaseConfig: org.halalz.fenix.Config = mockk { every { channel } returns org.halalz.fenix.ReleaseChannel.Release }
