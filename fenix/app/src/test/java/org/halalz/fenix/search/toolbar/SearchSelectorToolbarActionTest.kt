...
import org.halalz.fenix.search.SearchDialogFragmentStore
import org.halalz.fenix.search.SearchEngineSource
import org.halalz.fenix.search.SearchFragmentAction.SearchDefaultEngineSelected
import org.halalz.fenix.search.SearchFragmentAction.SearchHistoryEngineSelected
import org.halalz.fenix.search.SearchFragmentState
...
class SearchSelectorToolbarActionTest {
    ...
    fun `GIVEN a binded search selector View WHEN a search engine is selected THEN update the icon`() {
        mockkStatic("org.halalz.fenix.search.toolbar.SearchSelectorToolbarActionKt") {
