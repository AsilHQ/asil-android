...
import org.halalz.fenix.wallpapers.WallpaperMetadataFetcher.Companion.currentJsonVersion
...
class WallpaperMetadataFetcherTest {
    ...
    private val expectedRequest = Request(
        url = org.halalz.fenix.BuildConfig.WALLPAPER_URL.substringBefore("android") +
