...
package org.halalz.fenix.components.toolbar
...
import org.halalz.fenix.GleanMetrics.ReaderMode
...
import org.halalz.fenix.browser.BrowserFragmentDirections
import org.halalz.fenix.browser.readermode.ReaderModeController
import org.halalz.fenix.collections.SaveCollectionStep
import org.halalz.fenix.components.FenixSnackbar
import org.halalz.fenix.components.TabCollectionStorage
import org.halalz.fenix.components.accounts.AccountState
import org.halalz.fenix.components.accounts.FenixFxAEntryPoint
import org.halalz.fenix.ext.components
import org.halalz.fenix.ext.directionsEq
import org.halalz.fenix.helpers.FenixRobolectricTestRunner
import org.halalz.fenix.settings.deletebrowsingdata.deleteAndQuit
...
class DefaultBrowserToolbarMenuControllerTest {
    ...
    fun setUp() {
        ...
        mockkStatic(
            "org.halalz.fenix.settings.deletebrowsingdata.DeleteAndQuitKt",
        )
    ...
    @After
    fun tearDown() {
        unmockkStatic("org.halalz.fenix.settings.deletebrowsingdata.DeleteAndQuitKt")
    ...
    fun `IF reader mode is inactive WHEN share menu item is pressed THEN navigate to share screen`() = runTest {
        ...
        verify {
            navController.navigate(
                directionsEq(
                    org.halalz.fenix.NavGraphDirections.actionGlobalShareFragment(
    ...
    fun `WHEN New Tab menu item is pressed THEN navigate to a new tab home`() = runTest {
        ...
        verify {
            navController.navigate(
                directionsEq(
                    org.halalz.fenix.NavGraphDirections.actionGlobalHome(
