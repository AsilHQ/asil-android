...
import org.halalz.fenix.BuildConfig.DEEP_LINK_SCHEME
...
class HomeDeepLinkIntentProcessorTest {
    ...
    fun `process home deep link`() {
        ...
        verify { activity wasNot Called }
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalHome()) }
        verify { out wasNot Called }
    }
    ...
    fun `process urls_bookmarks deep link`() {
        ...
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalBookmarkFragment(BookmarkRoot.Root.id)) }
        verify { out wasNot Called }
    }
    ...
    fun `process urls_history deep link`() {
        ...
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalHistoryFragment()) }
        verify { out wasNot Called }
    }
    ...
    fun `process settings deep link`() {
        ...
        verify { activity wasNot Called }
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalSettingsFragment()) }
        verify { out wasNot Called }
    }
    ...
    fun `process turn_on_sync deep link`() {
        ...
        verify {
            navController.navigate(
                org.halalz.fenix.NavGraphDirections.actionGlobalTurnOnSync(
    ...
    fun `process settings_search_engine deep link`() {
        ...
        verify { activity wasNot Called }
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalSearchEngineFragment()) }
        verify { out wasNot Called }
    }
    ...
    fun `process settings_accessibility deep link`() {
        ...
        verify { activity wasNot Called }
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalAccessibilityFragment()) }
        verify { out wasNot Called }
    }
    ...
    fun `process settings_delete_browsing_data deep link`() {
        ...
        verify { activity wasNot Called }
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalDeleteBrowsingDataFragment()) }
        verify { out wasNot Called }
    }
    ...
    fun `process settings_addon_manager deep link`() {
        ...
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalAddonsManagementFragment()) }
        verify { out wasNot Called }
    }
    ...
    fun `process settings_logins deep link`() {
        ...
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalSavedLoginsAuthFragment()) }
        verify { out wasNot Called }
    }
    ...
    fun `process settings_tracking_protection deep link`() {
        ...
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalTrackingProtectionFragment()) }
        verify { out wasNot Called }
    }
    ...
    fun `process make_default_browser deep link for API 23 and below`() {
        ...
        every { activity.packageName } returns "org.halalz.fenix"
        every { activity.packageManager } returns packageManager
        @Suppress("DEPRECATION")
        every { packageManager.getPackageInfo("org.halalz.fenix", 0) } returns packageInfo
    ...
    fun `process settings_wallpapers deep link`() {
        ...
        verify { navController.navigate(org.halalz.fenix.NavGraphDirections.actionGlobalWallpaperSettingsFragment()) }
        verify { out wasNot Called }
    }
