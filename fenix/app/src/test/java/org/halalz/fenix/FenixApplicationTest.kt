...
class FenixApplicationTest {
    ...
    private lateinit var application: org.halalz.fenix.FenixApplication
    ...
    fun `WHEN setStartupMetrics is called THEN sets some base metrics`() {
        val expectedAppName = "org.halalz.fenix"
        val expectedAppInstallSource = "org.halalz.install.source"
