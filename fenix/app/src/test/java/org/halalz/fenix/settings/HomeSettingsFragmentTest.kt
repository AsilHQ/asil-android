...
internal class HomeSettingsFragmentTest {
    ...
    @Before
    fun setup() {
        mockkStatic("org.halalz.fenix.ext.FragmentKt")
    ...
    @After
    fun teardown() {
        unmockkStatic("org.halalz.fenix.ext.ContextKt")
        unmockkStatic("org.halalz.fenix.ext.FragmentKt")
    }
    ...
    fun `GIVEN the Pocket sponsored stories feature is disabled for the app WHEN accessing settings THEN the settings for it are not visible`() {
        mockkObject(org.halalz.fenix.FeatureFlags) {
            every { org.halalz.fenix.FeatureFlags.isPocketSponsoredStoriesFeatureEnabled(any()) } returns false
    ...
    fun `GIVEN the Pocket sponsored stories feature is enabled for the app WHEN accessing settings THEN the settings for it are visible`() {
        mockkObject(org.halalz.fenix.FeatureFlags) {
            every { org.halalz.fenix.FeatureFlags.isPocketSponsoredStoriesFeatureEnabled(any()) } returns true
