...
package org.halalz.fenix.shortcut
...
class PwaOnboardingObserverTest {
    ...
    private lateinit var lifecycleOwner: org.halalz.fenix.shortcut.PwaOnboardingObserverTest.MockedLifecycleOwner
    ...
    fun setUp() {
        ...
        lifecycleOwner =
            org.halalz.fenix.shortcut.PwaOnboardingObserverTest.MockedLifecycleOwner(Lifecycle.State.STARTED)
